...
function TextInput() {
  ...
  return (
    <div className="flex flex-col px-6 py-2 pb-8 text-sm w-9/12 m-auto">
        <textarea onChange={descriptionHandler} value={textState} id="description" className="border p-2 border-theme-blue h-32 bg-bg-grey" placeholder="What is your opinion?"></textarea>
    </div>
  );
}
